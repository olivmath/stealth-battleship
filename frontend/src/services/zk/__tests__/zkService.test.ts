import { ZKProvider, BoardValidityInput, BoardValidityResult, ShotProofInput, ShotProofResult, TurnsProofInput, TurnsProofResult } from '../types';
import { initZK, boardValidity, shotProof, turnsProof } from '../zkService';
